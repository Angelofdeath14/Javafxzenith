...
public class AffichageEventController implements Initializable {
    ...
    @FXML private void goToAddEvent() { navigateTo("AjouterEvent.fxml", "Ajouter un événement"); }
    @FXML private void goToEvents()   { loadEvents(); }
    @FXML private void goToUsers()    { navigateTo("ListUsers.fxml", "Gestion des utilisateurs"); }
    @FXML private void goToProduit()  { navigateTo("produit-admin.fxml", "Gestion des produits"); }
    @FXML private void goToCommands() { navigateTo("commande-admin.fxml", "Gestion des commandes"); }
    @FXML private void goToReclamation() { navigateTo("afficher-reclamation-admin.fxml", "Gestion des réclamations"); }
    @FXML private void logout()       { navigateTo("Login.fxml", "Connexion"); }
    @FXML private void refreshDashboard() { navigateTo("Dashboard.fxml", "Dashboard"); }
}
